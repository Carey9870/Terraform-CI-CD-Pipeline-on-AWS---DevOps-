# process: create VPC - SG (Security Groups) - EC2
...
module "vpc" {
    ...
    public_subnet_tags = {
        Name = "jenkins-subnet"  #name of public subnets
    }
}
...
module "sg" {
    ...
    vpc_cidr       = module.vpc.vpc_id  #the above vpc
    ...
    tags = {
        Name = "jenkins-sg"  # name of the SG Group
    }
}
